...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Ismatic Engineering - <?php echo $web_title; ?></title>
...
Engineering related scientific and technical consulting activities">
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar">
        ...
        <nav class="navbar navbar-default navbar-fixed-top mega navbar-inverse navbar-trans" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="index.php" style="margin-top: -15px;" ><img src="wall/logo/ismatic2b.png" height="70px" width="70px" alt="Ismatic - Logo"></a>
            </div><!-- / .navbar-header -->
